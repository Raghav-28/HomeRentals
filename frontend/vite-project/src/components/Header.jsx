        ...
        {/* CONTAINER */}
            <div className="flexBetween">
                ...
                <div className="flexCenter gap-x-4">
                    ...
                    {/* MOBILE */}
                    <Navbar  containerStyles={`${menuOpened ? "flex items-start flex-col gap-y-8 capitalize fixed top-20 right-8 p-12 bg-white shadow-md rounded-2xl w-64 medium-15 ring-slate-900/5 transition-all duration-300 z-50" : 
                    "flex items-start flex-col gap-y-8 capitalize fixed top-20 right-[100%] p-12 bg-white shadow-md rounded-2xl w-64 medium-15 ring-slate-900/5 transition-all duration-300 "}`} />
                ...
                <div className="flexBetween gap-x-3 sm:gap-x-5 bold-16">
                   { !menuOpened ? (
                    ...
                    <button className="flexCenter gap-x-2 px-5 bg-black text-white rounded-lg">
