  ...
  return (
    <section className="max-padd-container bg-hero bg-cover bg-no-repeat h-[722px] w-full">
      <div className="relative top-32 xs:top-48">
        <h1 className="h1 capitalize ma-w-[41rem]">Discover Your Dream Property Today</h1>
        <p className="my-5 max-w-[33rem]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, iure! Praesentium esse excepturi totam maiores error omnis odio consectetur neque blanditiis illo!</p>
